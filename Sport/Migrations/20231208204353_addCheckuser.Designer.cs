...
namespace Sport.Migrations
{
    ...
    [Migration("20231208204353_addCheckuser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sport.Models.Check_user", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("ClassesGroupId");

                    b.HasIndex("StudentsId");

                    b.ToTable("Check_user");
                });

            modelBuilder.Entity("Sport.Models.ClassesGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int?>("GroupClassesRaspisId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GroupClassesRaspisId");
            ...
            modelBuilder.Entity("Sport.Models.Check_user", b =>
                {
                    b.HasOne("Sport.Models.ClassesGroup", "ClassesGroup")
                        .WithMany()
                        .HasForeignKey("ClassesGroupId");

                    b.HasOne("Sport.Models.Students", "Students")
                        .WithMany()
                        .HasForeignKey("StudentsId");

                    b.Navigation("ClassesGroup");
            ...
            modelBuilder.Entity("Sport.Models.ClassesGroup", b =>
                {
                    b.HasOne("Sport.Models.GroupClassesRaspis", "GroupClassesRaspis")
                        .WithMany()
                        .HasForeignKey("GroupClassesRaspisId");

                    b.HasOne("Sport.Models.Students", "Students")
                        .WithMany()
                        .HasForeignKey("StudentsId");

                    b.Navigation("GroupClassesRaspis");
